...
async function updateSettings() {
  ...
  await payload.updateGlobal({
    ...
    data: {
      ...
      siteMetaDescription: 'Ankara su deposu imalatçısı İlhan Su Depoları. Yüksek kaliteli polietilen dikey ve yatay plastik su depoları uygun fiyat ve fabrika garantisiyle.',
      siteMetaKeywords: 'su deposu, ankara su deposu, polietilen su deposu, plastik su deposu, su deposu fiyatları',
    } as any,
  })
