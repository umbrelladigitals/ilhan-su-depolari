      ...
      <div className="container-custom">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
          ...
          <div className="lg:col-span-5 space-y-5 flex flex-col justify-between">
            <div>
              <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-sky-100/80 border border-sky-200 text-sky-800 text-xs font-bold mb-3 shadow-sm">
            ...
            <div className="space-y-3">
              <div className="flex items-start gap-3.5 p-3 rounded-xl bg-slate-50 border border-slate-200/80">
                <div className="w-9 h-9 rounded-lg bg-sky-100 text-sky-700 flex items-center justify-center shrink-0 mt-0.5">
                  <MapPin className="w-4 h-4" />
                </div>
                <div>
                  <div className="text-[11px] font-bold text-slate-500">Fabrika & Merkez Adres</div>
              ...
              <div className="flex items-start gap-3.5 p-3 rounded-xl bg-slate-50 border border-slate-200/80">
                ...
                <div>
                  <div className="text-[11px] font-bold text-slate-500">Ofis & Fabrika Numaraları</div>
                  <div className="flex flex-col sm:flex-row sm:gap-4 mt-0.5 text-xs font-extrabold text-sky-700">
                    <a href={`tel:${phoneDisplay.replace(/\s+/g, '')}`} className="hover:underline">
                      Ofis: {phoneDisplay}
                    </a>
                    <a href={`tel:${factoryPhoneDisplay.replace(/\s+/g, '')}`} className="hover:underline">
              ...
              <div className="flex items-start gap-3.5 p-3 rounded-xl bg-slate-50 border border-slate-200/80">
                ...
                <div>
                  <div className="text-[11px] font-bold text-slate-500">WhatsApp Canlı Hat</div>
                  <a
              ...
              <div className="flex items-start gap-3.5 p-3 rounded-xl bg-slate-50 border border-slate-200/80">
                ...
                <div>
                  <div className="text-[11px] font-bold text-slate-500">Çalışma Saatleri</div>
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="btn-emerald-whatsapp w-full py-3 px-4 text-xs font-extrabold flex items-center justify-center gap-2 text-center shadow-md mt-2 cursor-pointer"
            >
              <MessageSquare className="w-4 h-4 fill-current" />
          ...
          {/* Google Harita Section (Modüler MapSection) */}
          <div className="lg:col-span-7">
            <MapSection siteSettings={siteSettings} title="" subtitle="" />
          </div>
        </div>
      </div>
    </section>
